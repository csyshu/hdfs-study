...
@Api(value = "HDFS目录管理")
@Slf4j
public class HdFsDirController {
    ...
    public Object isExist(String directorName) {
        try {
            if (StringUtils.isNotBlank(directorName)) {
                return ResponseUtil.successResponse(HdFsUtil.resourceIsExist(directorName));
    ...
    public Object isDirector(String directorName) {
        try {
            if (StringUtils.isNotBlank(directorName)) {
                return ResponseUtil.successResponse(HdFsUtil.isDirector(directorName));
            } else {
    ...
    public Object add(String directorName) {
        try {
            if (StringUtils.isNotBlank(directorName)) {
                return ResponseUtil.successResponse(HdFsUtil.mkDirs(directorName));
            } else {
    ...
    public Object del(String directorName) {
        try {
            if (StringUtils.isNotBlank(directorName)) {
                return ResponseUtil.successResponse(HdFsUtil.delResources(directorName, true));
            } else {
    ...
    public Object rename(String oldDirectorName, String newDirectorName) {
        try {
            if (StringUtils.isNotBlank(oldDirectorName) && StringUtils.isNotBlank(newDirectorName)) {
                return ResponseUtil.successResponse(HdFsUtil.renameResource(oldDirectorName, newDirectorName));
            } else {
    ...
    public Object list(String directorName) {
        try {
            if (StringUtils.isNotBlank(directorName)) {
                return ResponseUtil.successResponse(HdFsUtil.listFiles(directorName));
            } else {
